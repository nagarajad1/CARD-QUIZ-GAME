        ...
        bRegisterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isAllFieldsChecked) {
                    SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(RegisterView.this);
                    SharedPreferences.Editor edit = pref.edit();
                    edit.putString("email", String.valueOf(etEmail.getText()));
                    edit.putString("password", String.valueOf(etPassword.getText()));
                    edit.apply();
